...
class SingleLassoSelector:
    """
    Structure for selecting data points within a lasso path on a matplotlib scatter plot. 
    It allows users to draw a freeform lasso around points to select them, and optionally
