...
\newcommand{\Fdot}[0]{\dot{\tensorTwo{\mathrm{F}}}}
\newcommand{\Cdot}[0]{\dot{\tensorTwo{\mathrm{C}}}}
\newcommand{\Edot}[0]{\dot{\tensorTwo{\mathrm{E}}}}

\newcommand{\lll}[0]{\tensorTwo{\ell}}
\newcommand{\ddd}[0]{\tensorTwo{d}}
...
\newcommand{\Celastic}{\tensorFour{\mathcal{C}}}
...
\nomenclature{$\vec{u}$}{Displacement vector}
...
\nomenclature{$\vec{v}$}{Velocity of the transformation}
\nomenclature{$\Fdot$}{Material velocity gradient}
\nomenclature{$\Edot$}{Material deformation rate tensor}
\nomenclature{$\lll$}{Spatial velocity gradient}
\nomenclature{$\ddd$}{Deformation rate tensor}
...
\include{sections/02_kinematics_stress}

\include{sections/03_materials}

\include{sections/04_finite_elements}

\include{sections/05_linear_solution}

\include{sections/06_non_linear_solution}
