...
\section{Linear Materials} \label{sec:lin_mat}
...
\begin{equation} \label{eq:small_disp}
...
The Equation \ref{eq:sigma_linear_elastic_iso} is also known as the generalized Hooke's law for isotropic materials. This is written as a function of the stiffness tensor, which is given by:

\begin{equation} \label{eq:sigma_linear_elastic_iso_C}
    \cauchy = \tensorFour{\mathcal{C}} : \tensorTwo{\varepsilon} \qquad \text{with} \qquad
...
\section{Non Linear Materials}  \label{sec:non_lin_mat}
